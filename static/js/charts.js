...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleResults = samplesArray[0];
    ...
    var barLayout = {
      title: "<b>Top 10 bacterial species (OTUs)</b> ",
      paper_bgcolor: '#DDEEF8',
      plot_bgcolor: '#DDEEF8',
    ...
    var gaugeData = [{
      value: wfreq,
      title: {text: "<b> Belly Button Washing Fequency </b> <br></br> Scrubs Per Week"},
      type: "indicator",
      mode:"gauge+number",
      gauge: {
